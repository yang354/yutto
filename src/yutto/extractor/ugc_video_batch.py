...
from yutto.path_templates import UNKNOWN
            ...
            CoroutineWrapper(
                extract_ugc_video_data(
                    ...
                    options,
                    {
                        ...
                        "tname": ugc_video_list.get("tname", UNKNOWN),
                        "first_tag": ugc_video_list.get("tags", [UNKNOWN])[0] if ugc_video_list.get("tags") else UNKNOWN,
                    },
                    "{title}/{name}",
                )
            )
